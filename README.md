...
wine_reviews['top_rated_regions'] = 
...
# univariate methods which consider only one feature at a time
# or selecting all the best features at once with L1 (Lasso regression) or L2 (Ridge regression) regularization
# L1 - linear model
